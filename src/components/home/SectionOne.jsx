            ...
            <div className="font-paperlogy w-full h-[100vh] max-md:h-auto max-md:py-24 flex items-center justify-center">
                ...
                <div className='flex flex-col w-full gap-6 relative'>
                    ...
                    <motion.div
                        ...
                        <div className='relative w-full h-full scale-65 mt-6'>
                        ...
                        <div className='px-6 flex flex-col gap-2 mb-6'>
                            ...
                            <p className='text-[#f9f9f9]/50 text-sm'>모션그래픽·3D 백그라운드에서 비롯된 시각적 감각을 코드로 구현합니다. <br/><br/></p>
                        </div>
                    </motion.div>
                    ...
                    <motion.div
                        ...
                        <div className='px-6 flex flex-col gap-2 mb-6'>
                            ...
                            <p className='text-[#f9f9f9]/50 text-sm'>Cinema 4D 폴리곤 모델링과 Fusion 360 넙스 모델링으로 3D를 다뤄왔습니다. 이제 Blender와 Spline으로 그 감각을 웹 환경에 옮기고자 합니다.<br/> <br/> </p>
                        </div>
                    </motion.div>
                    ...
                    <motion.div
                        ...
                        <div className='px-6 flex flex-col gap-2 mb-6'>
                            ...
                            <p className='text-[#f9f9f9]/50 text-sm'>React 상태 관리와 fetch API를 기반으로 데이터를 다루는 로직을 연습합니다. CRUD, 페이지네이션, 필터, 검색까지 실무형 흐름으로 구현합니다. <br/> <br/></p>
                        </div>
                    </motion.div>
                    </div>
